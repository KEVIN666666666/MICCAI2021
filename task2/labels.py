"""
using open resources from https://github.com/WZMIAOMIAO/deep-learning-for-image-processing/blob/master/tensorflow_classification/Test9_efficientNet/model.py
"""
